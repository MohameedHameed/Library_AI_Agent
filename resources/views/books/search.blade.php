    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-600 mb-6 max-w-md mx-auto">
                        لم نتمكن من العثور على كتب تطابق بحثك "{{ $query }}". جرب كلمات بحث مختلفة أو أقل تحديداً.
                    </p>
                    <a
                        href="{{ route('dashboard') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col group">
                    <!-- Book Cover -->
                    <div class="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        ...
                        <div class="absolute bottom-2 left-2">
                            <span class="bg-black bg-opacity-60 text-white text-xs font-semibold px-2 py-1 rounded-full">
                    ...
                    <div class="p-4 flex-1 flex flex-col">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-200">
                            ...
                            <div class="flex flex-wrap gap-1">
                                ...
                                <a href="{{ $book['download_links']['text/html'] }}"
                                    target="_blank"
                                ...
                                <a href="{{ $book['download_links']['text/plain'] }}"
                                    target="_blank"
